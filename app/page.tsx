          ...
          <section className="py-20 flex flex-col items-center gap-10">
            ...
            >
              ...
              <a
                ...
                className="group flex items-center gap-3 px-6 py-3.5 rounded-2xl font-bold text-sm transition-all duration-300 hover:scale-105 active:scale-95"
                style={{
                  background: "linear-gradient(135deg, #229ED9 0%, #1a8bbf 100%)",
                  color: "#fff",
                  boxShadow: "0 4px 24px rgba(34,158,217,0.35)",
                }}
              >
                ...
                Telegram
                <span className="text-white/60 group-hover:text-white/90 transition-colors text-xs">↗</span>
              </a>
              ...
              <a
                ...
                style={{
                  ...
                  color: "#fff",
                  boxShadow: "0 4px 24px rgba(255,0,0,0.30)",
                }}
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
