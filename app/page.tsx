...
export default function FocusTimerPage() {
  ...
  const flipItems = [
    ...
    { letter: "T", icon: <FaTelegram />, label: "Telegram", href: "https://t.me/EliteForce_Official" },
  ];
      ...
      <main className="relative min-h-screen overflow-x-hidden bg-background text-foreground" style={{ fontFamily: "'Inter',sans-serif" }}>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section id="contact" className="py-20 flex flex-col items-center gap-12">
            ...
            >
              ...
              >
                ...
                <motion.a
                  ...
                  href="https://t.me/EliteForce_Official"
                  target="_blank"
                ...
                <motion.a
                  variants={contactItemVariants}
                  href="https://www.youtube.com/@EliteForceOfficialChannel"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative flex flex-col items-center justify-center gap-4 py-12 px-6 transition-all duration-300"
                  style={{ borderRight: "1px solid var(--border)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}
            ...
            {/* Mobile/Phone: Infinite Horizontal Marquee Slider for Social Links */}
            <div className="block sm:hidden relative w-full overflow-hidden mt-6 py-2">
              {/* Fade overlays on left/right for seamless blending */}
              <div className="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-background to-transparent z-10 pointer-events-none" />
              <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-background to-transparent z-10 pointer-events-none" />

              <div className="flex gap-3 animate-marquee py-2 select-none" style={{ "--marquee-speed": "12s" } as React.CSSProperties}>
                {[
                  {
                    name: "Telegram",
                    href: "https://t.me/EliteForce_Official",
                ...
                ].reduce((acc, curr) => [...acc, curr, curr, curr, curr], [] as any[]).map((w, idx) => (
                  <a
                    key={idx}
                    href={w.href}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2.5 py-3 px-3.5 rounded-2xl w-48 shrink-0 transition-all duration-300 shadow-md shadow-black/5"
