...
const MorphingIcon = ({ type, isActive, onClick, onMouseEnter }: { type: string, isActive: boolean, onClick: () => void, onMouseEnter?: () => void }) => {
    ...
    if (type === 'home') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("glass-dock-btn home", isActive ? "active" : "")}>
    ...
    if (type === 'blog') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("glass-dock-btn blog", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
    ...
    if (type === 'marker') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("glass-dock-btn marker", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
    ...
    if (type === 'email') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("glass-dock-btn email", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
    ...
    if (type === 'linkedin') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("glass-dock-btn linkedin", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
    ...
    if (type === 'x') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("glass-dock-btn x", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
    ...
    if (type === 'github') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={cn("glass-dock-btn github", isActive ? "active" : "")}>
                <svg viewBox="0 0 24 24">
        ...
        return (
            ...
            >
                <style dangerouslySetInnerHTML={{ __html: `
                    ...
                    .glass-dock-btn.active, .glass-dock-btn:hover {
                        color: #FF8A00;
                    }
                    .glass-dock-btn svg {
                        width: 26px;
                    ...
                    .glass-dock-btn.home {
                        ...
                        opacity: var(--tab-bar-home-opacity, 1);
                    }
                    .glass-dock-btn.blog {
                        transform: scale(var(--tab-bar-blog-scale, 1));
                        opacity: var(--tab-bar-blog-opacity, 1);
                    }
                    .glass-dock-btn.marker {
                        transform: scale(var(--tab-bar-marker-scale, 1));
                        opacity: var(--tab-bar-marker-opacity, 1);
                    }
                    .glass-dock-btn.email {
                        transform: scale(var(--tab-bar-email-scale, 1));
                        opacity: var(--tab-bar-email-opacity, 1);
                    }
                    .glass-dock-btn.linkedin {
                        transform: scale(var(--tab-bar-linkedin-scale, 1));
                        opacity: var(--tab-bar-linkedin-opacity, 1);
                    }
                    .glass-dock-btn.x {
                        transform: scale(var(--tab-bar-x-scale, 1));
                        opacity: var(--tab-bar-x-opacity, 1);
                    }
                    .glass-dock-btn.github {
                        transform: scale(var(--tab-bar-github-scale, 1));
                        opacity: var(--tab-bar-github-opacity, 1);
                    }
                ` }} />
                <div
                    className={cn(
                ...
                >
                    ...
                    {items.map((el, index) => {
                        ...
                        const isActive = el.isActive !== undefined ? el.isActive : isHovered;
                        ...
                        const type = animationMapping[el.title.toLowerCase()] || el.title.toLowerCase();
