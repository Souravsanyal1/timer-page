...
export const WalletIcons: Record<string, React.ReactNode> = {
  ...
  TokenPocket: (
    <img src="https://i.postimg.cc/DZ47Hpxj/unnamed.webp" alt="" aria-hidden="true" className="w-9 h-9 object-contain" />
  ),
  Trust: (
    <img src="https://i.postimg.cc/TPWS68XV/trust-wallet-icon.webp" alt="" aria-hidden="true" className="w-9 h-9 object-contain" />
  ),
  OneInch: (
    <img src="https://i.postimg.cc/5NbMStWK/unnamed-(1).webp" alt="" aria-hidden="true" className="w-9 h-9 object-contain" />
  ),
}
